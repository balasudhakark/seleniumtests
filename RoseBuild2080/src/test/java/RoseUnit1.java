...
import pomFramework.LoginRose;
import pomFramework.MemWord;
import pomFramework.OpenURL;
...
public class RoseUnit1 {
	...
	FileInputStream xlFile = new FileInputStream("src//testData//testData.xls");
	//Load book
